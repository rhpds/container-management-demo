...
This demo is designed to help you understand the key features and capabilities of OpenShift as a Container Management Platform.

**Owner:** mpbravo
**Migrated from:** https://github.com/mpbravo/showroom_container-management-demo
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/container-management-demo`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/container-management-demo
   ```
3. `cd container-management-demo`
